...
import { reviewerList } from '../../static/js/util/reviewer-list.js';
import { updateHash } from './image-review.js';
        ...
        <div id="reviewerRow${thisReviewerIndex}" class="row pt-1">
            ...
            <button type="button" id="reviewerName${thisReviewerIndex}Button" class="btn reviewerNameButton" name="reviewerName">
                <div class="row">
                    ...
                    <div class="col-1 me-2">${Icons.chevronDown}</div>
                </div>
            </button>
            <div class="col-1 mt-1">
                <button id="xButton${thisReviewerIndex}" type="button" class="xButton">${Icons.x}</button>
            </div>
        </div>
    `);
