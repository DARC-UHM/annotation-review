...
@tator_bp.get('/tator/sections/<project_id>')
...
@tator_bp.get('/tator/deployments/<project_id>/<section_id>')
...
@tator_bp.get('/tator/refresh-sections')
...
@tator_bp.get('/tator/frame/<media_id>/<frame>')
...
@tator_bp.get('/tator/localization-image/<localization_id>')
...
@tator_bp.patch('/tator/localization')
...
@tator_bp.patch('/tator/localization/good-image')
