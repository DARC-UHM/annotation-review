...
@tator_qaqc_bp.get('/qaqc/tator/checklist')
...
@tator_qaqc_bp.patch('/qaqc/tator/checklist')
...
@tator_qaqc_bp.get('/qaqc/tator/check/<check>')
...
@tator_qaqc_bp.get('/qaqc/tator/attracted-list')
def attracted_list():
...
@tator_qaqc_bp.post('/qaqc/tator/attracted')
def add_attracted():
    res = requests.post(
...
@tator_qaqc_bp.patch('/qaqc/tator/attracted/<concept>')
...
@tator_qaqc_bp.delete('/qaqc/tator/attracted/<concept>')
