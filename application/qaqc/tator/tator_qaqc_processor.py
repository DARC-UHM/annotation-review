...
from application.qaqc.tator.image_guide_presentation import ImageGuidePresentation
...
class TatorQaqcProcessor(TatorLocalizationProcessor):
    ...
    def download_image_guide(self, token):
        """
        ...
        self.localizations = records_of_interest
        self.process_records()
        return ImageGuidePresentation(tator_url=self.tator_url, token=token).build(self.final_records)
