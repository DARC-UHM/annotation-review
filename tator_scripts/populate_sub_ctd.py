...
TODO also should be syncing lat/long here.
...
def populate_ctd(expedition_name: str, dry_run: bool):
    ...
    #     find the closest qinsy timestamp to the localization timestamp, populate CTD
...
def get_qinsy_df(dropbox_client: dropbox.Dropbox, qinsy_folder_path: str):
    ...
    for expected_col_header in [
        ...
        'TMP Value',  # TODO confirm
        'DO Concentration Salin Comp (mol/L)', # TODO find if this actually there
    ]:
